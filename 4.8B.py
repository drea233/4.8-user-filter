# importing PIL.Image library and os library and random
...
def newFilter():
  #asks for user input
  changeR = int(input("Type a number between 0 - 255 inclusive: "))
  changeB = int(input("Type another number between 0 - 255 inclusive: "))
  changeG = int(input("Type the final number between 0 - 255 inclusive: "))
